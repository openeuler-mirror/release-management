...
| [ID96TK](https://gitee.com/openeuler/release-management/issues/ID96TK?from=project-issue) | 慢IO/慢盘检测能力增强 | Developing | sig-AccLib | [@guchenghua1992](https://gitee.com/guchenghua1992/) | Everything | krun |
| [ID96UN](https://gitee.com/openeuler/release-management/issues/ID96UN?from=project-issue) | CompassCI支持功能和性能自动化测试以及性能变化补丁识别定位 | Developing | sig-cicd | [@duan_pj](https://gitee.com/duan_pj/) | Everything | compass-ci |
| [ID96VT](https://gitee.com/openeuler/release-management/issues/ID96VT?from=project-issue) | oeDeploy支持AI Agent开发场景工具栈，支持CANN软件环境与昇腾驱动的快速部署 | Developing | sig-ops | [@dingjiahuichina](https://gitee.com/dingjiahuichina/) | Everything | oeDeploy |
| [ID96W0](https://gitee.com/openeuler/release-management/issues/ID96W0?from=project-issue) | DevStation支持MCP开发工具链和增强AI助手Agent创建，提升开发者体验，使能CVE漏洞修复提效 | Developing | sig-intelligence | [@duan_pj](https://gitee.com/duan_pj/) | Everything | mcp-servers |
| [ID96XG](https://gitee.com/openeuler/release-management/issues/ID96XG?from=project-issue) | 引入IOInflight QoS控制器，降低混部场景在线业务干扰率 | Developing | sig-kernel | [@yang-erkun](https://gitee.com/yang-erkun/) | BaseOS | kernel |
| [ID9CXA](https://gitee.com/openeuler/release-management/issues/ID9CXA?from=project-issue) | SPDK支持vq均衡多reactor功能，降低虚拟化开销 | Developing | sig-Storage | [@ShenYage](https://gitee.com/ShenYage/) | Everything | spdk |
| [ID9D2R](https://gitee.com/openeuler/release-management/issues/ID9D2R?from=project-issue) | openEuler Intelligence智能平台支持智能诊断、智能调优和数据治理流水线开放能力 | Developing | sig-intelligence | [@zxstty](https://gitee.com/zxstty/) | Everything | euler-copilot-rag, euler-copilot-witchaind-web|
| [ID9DCD](https://gitee.com/openeuler/release-management/issues/ID9DCD?from=project-issue) | sysHAX 支持支持7B 中小稠密模型推理算力填充 | Developing | sig-intelligence | [@xiaocy1997](https://gitee.com/xiaocy1997/) | Everything | sysHAX |
| [ID9DEY](https://gitee.com/openeuler/release-management/issues/ID9DEY?from=project-issue) | ModelFS提升推理服务启动速度 | Developing | sig-kernel | [@yubo-liu](https://gitee.com/yubo-liu/) | BaseOS | Kernel |
| [ID9DH3](https://gitee.com/openeuler/release-management/issues/ID9DH3?from=project-issue) | GMem异构融合内存提升异构资源利用率 | Developing | sig-kernel | [@ni-cunshu](https://gitee.com/ni-cunshu/) | BaseOS | Kernel |
| [ID9DLK](https://gitee.com/openeuler/release-management/issues/ID9DLK?from=project-issue) | 毕昇JDK21支持元数据压缩优化降低堆数据内存使用 | Developing | Compiler SIG | [@xiejf2020](https://gitee.com/xiejf2020/) |  | openjdk-21 |
| [ID9DND](https://gitee.com/openeuler/release-management/issues/ID9DND?from=project-issue) | TF原生Embedding算子图优化提高推理性能 | Developing | Compiler SIG | [@li-yancheng](https://gitee.com/li-yancheng/) |  | ANNC |
| [ID9DPA](https://gitee.com/openeuler/release-management/issues/ID9DPA?from=project-issue) | 毕昇JDK21版本 G1、PS支持堆内存扩缩容 | Developing | Compiler SIG | [@xiejf2020](https://gitee.com/xiejf2020/) |  | openjdk-21 |
| [ID9DQQ](https://gitee.com/openeuler/release-management/issues/ID9DQQ?from=project-issue) | LLVM编译器提升数据库（MySQL）、压缩解压缩（lz4/zstd/xz）等性能 | Developing | Compiler SIG | [@eastb233](https://gitee.com/eastb233/) |  | llvm-project,llvm |
| [ID9DRP](https://gitee.com/openeuler/release-management/issues/ID9DRP?from=project-issue) | 毕昇JDK21支持JIT warmup， 提升Java启动性能 | Developing | Compiler SIG | [@xiejf2020](https://gitee.com/xiejf2020/) |  | openjdk-21 |
| [IDBW00](https://gitee.com/openeuler/release-management/issues/IDBW00?from=project-issue) | RISC-V 架构面向 RVA23 指令集扩展规范推出正式版本 | Developing | RISC-V SIG | [@jchzhou](https://gitee.com/jchzhou) | ISO | ISO |
